...
const AboutUs = () => {
  return (
    <>
      ...
      <section className="damier-light-bugundy">
        <div className="container">
      ...
      <section className="rounded-lg">
        <div className="container">
            <div className="row justify-content-center">
                <div className="col-8 mt-4 pt-4" >
                    ...
                    <p className="text-center">When we started Damier Spaces in 2010, we wanted to build more than beautiful, shared office spaces.
        ...
        <div className="row pt-3 pb-4 justify-content-center">
            <div className="col-5">
                <h3 className="mb-2 text-center">We’re happy to find incredible offices</h3>
                <p className="text-center">Join the ranks of industry leaders turning to Damier Spaces for their commercial real estate needs.</p>
            </div>
        </div>
        <div className="container"> 
            <img src="../../assets/img/Vector 62.svg" className="img-fluid justify-content-center" />
        </div>
        <div className="container pt-4 pb-6">
            <div className="row justify-content-center">
                <img src="../../assets/img/clients 1.png" className="img-fluid" />
            </div>
        </div>
          </section>
        ...
        <div className="container">
            <div className="row pt-7 mb-3">
                <div className="col-lg-3 text-lg-left pr-lg-4">
                    ...
                    <a className="btn btn-primary" href="careers.html">Join Our Team</a>
                </div>
                <div className="col-lg-3 offset-lg-3">
                    <img src="../../assets/img/Rectangle 319.png" className="img-fluid rounded-lg"/>
                    <p className="mb-0 mt-2"><strong>Bosun Jones</strong></p>
                    <p ><small>PRINCIPAL PARTNER</small></p>
                </div>
                <div className="col-lg-3">
                    <img src="../../assets/img/Rectangle 320.png" className="img-fluid rounded-lg"/>
                    <p className="mb-0 mt-2"><strong>Kosara Okafor</strong></p>
                    <p><small>HEAD, TECHNOLOGY</small></p>
                </div>
            </div>
            <div className="row mb-3 justify-content-md-end">
                <div className="col-lg-3">
                    <img src="../../assets/img/Rectangle 321.png" className="img-fluid rounded-lg" />
                    <p className="mb-0 mt-2"><strong>Mordi Chukwu</strong></p>
                    <p><small>PEOPLE HR</small></p>
                </div>
                <div className="col-lg-3">
                    <img src="../../assets/img/Rectangle 322.png" className="img-fluid rounded-lg"/>
                    <p className="mb-0 mt-2"><strong>Ngozi Udeagbara</strong></p>
                    <p><small>CUSTOMER SUPPORT</small></p>
                </div>
            </div>
            <div className="row pb-5 justify-content-md-end">
                <div className="col-lg-3">
                    <img src="../../assets/img/Rectangle 343.png" className="img-fluid rounded-lg"/>
                    <p className="mb-0 mt-2"><strong>Ijeoma Chukwu</strong></p>
                    <p><small>PEOPLE HR</small></p>
                </div>
                <div className="col-lg-3">
                    <img src="../../assets/img/Rectangle 344.png" className="img-fluid rounded-lg" />
                    <p className="mb-0 mt-2"><strong>Ahmadu Haruna</strong></p>
                    <p><small>CUSTOMER SUPPORT</small></p>
                </div>
            </div>
        </div>
