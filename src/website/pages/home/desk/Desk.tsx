  ...
  <div className="container">
    <div className="row  pb-4 justify-content-md-between">
      ...
      <div className="col-lg-5 pt-10">
        ...
        <a className="btn btn-primary" href="how-it-works.html">How it works<i className="fas fa-chevron-right pl-2" /></a>
      </div>
    </div>
    <hr />
    <div className="row  py-4 justify-content-md-between">
      <div className="col-lg-5 pt-6 pr-6">
        ...
        <a className="btn btn-primary" href="#">Get Started<i className="fas fa-chevron-right pl-2" /></a>
      </div>
